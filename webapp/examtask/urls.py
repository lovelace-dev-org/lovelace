...
urlpatterns = [
    ...
    path(
        "<course:course>/<instance:instance>/<content:parent>/<content:content>/attempts/add/",
        views.add_task_attempt,
        name="add_task_attempt",
    ),
    path(
        "<course:course>/<instance:instance>/<content:parent>/<content:content>/"
        "attempts/<taskattempt:attempt>/rerandomize/",
        views.rerandomize_tasks,
        name="rerandomize_tasks",
    ),
    path(
        "<course:course>/<instance:instance>/<content:parent>/<content:content>/"
