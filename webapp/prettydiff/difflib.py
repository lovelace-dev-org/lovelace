...
# TODO: I think this does a crapload of passes? Modify to single-pass/reduce passes
class HtmlDiff(object):
    ...
    # TODO: Add more options for HTML customization
    ...
    def make_table(self, fromlines, tolines, fromdesc="", todesc="", context=False, numlines=5):
        ...
        return (
            table.replace("\0+", '<span class="diff-add">')
